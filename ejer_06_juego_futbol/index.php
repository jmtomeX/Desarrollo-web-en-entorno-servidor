    ...
    <footer class="footer pie-pagina">
        <div class="content has-text-centered">
            <p>
                ...
                <strong>Goools.es</strong> by <a href="#">José Mari Tomé</a>.
            </p>
            <figure>
                ...
                <img src="./assets/img/ajax.png" class="image is-64x64" alt="logo php">
                <img src="./assets/img/jquery.png" class="image is-64x64" alt="logo php">
            </figure>
        </div>
    </footer>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            function getAdvertisement() {
                $.get('http://localhost/josemaritome.com/forsale/api/controller.php?op=1',
                    function(data) {
                        ...
                        var img = "http://localhost/josemaritome.com/forsale/img/no_img.png";
                        ...
                        $("#adv_id").attr('href', "http://localhost/josemaritome.com/forsale/anuncios/anuncio_ind.php?id=" + anuncio_id);
                    });
